...
This repository contains the code used to calculate compiled survey indices for beaked and golden redfish in the Norwegian and Barents Seas, as presented in the paper. The workflow demonstrated here can be extended to other stocks using survey data from the Institute of Marine Research and beyond.

Code used to calculate compiled survey indices for beaked and golden redfish in the Norwegian and Barents Seas, as presented in the paper, will be uploaded here once data sharing and lisencing has been sorted out. 
